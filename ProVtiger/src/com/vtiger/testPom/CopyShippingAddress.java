...
public class CopyShippingAddress extends BaseTest {
	@Test
	public static void QuotePageCopyShippingAddress() throws EncryptedDocumentException, InvalidFormatException, InterruptedException
	{
	...
	Thread.sleep(8000);
	h.clickOnRadioButtopnOfCopyShippingAddress();
	Thread.sleep(8000);
