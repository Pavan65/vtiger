...
public class CreateQuoteusingQuoteStage extends BaseTest {
	@Test
	public static void QuotePageQuoteStage() throws EncryptedDocumentException, InvalidFormatException, InterruptedException
	{
	...
	h.clickOnCarrier();
	h.clickAndSelectCarrier();
	h.clickOnQuoteStage();
	h.clickAndSelectQuoteStageAccepted();
