...
public class createQuoteWithServices extends BaseTest {
	@Test
	public static void QuotePagWithServices() throws EncryptedDocumentException, InvalidFormatException, InterruptedException
	{
	...
	h.clickOnAddServices();
	h.clickOnAddServicesButton();
	String parent3 = driver.getWindowHandle();
	Set<String> subTab3 = driver.getWindowHandles();
	for(String tab : subTab3)
	{
		driver.switchTo().window(tab);
	}
	Thread.sleep(2000);
	h.clickAndSelectServiceName();
	Thread.sleep(2000);
	driver.switchTo().window(parent2);
